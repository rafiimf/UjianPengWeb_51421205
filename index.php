...
<body style= "background-image: url(Tsurumi.png); background-size:cover;">
    <!-- navbar -->
            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="tambah.php" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Rafii Ganteng" required>
                    </div>
                    <div class="col-md-4">
                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_nama" id="edit_nama" class="form-control" placeholder="Rafii Ganteng" required>
                            </div>
                            <div class="col-12 mb-3">
